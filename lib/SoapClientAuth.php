 ...
 * 
 *    GBoksar(gustavo@boksar.info) / 2015-01-23
 *    Minor modifications to give this class timeout functionallity. It's important 
 *    because despite server-side timeout, client might neeed to wait less for an
 *    answer.
 *    Changes made:
 *       - private property _timeout (pre-set at 120s)
 *       - public method setTimeOut(int) to set private property
 *       - add parameter one_way with default value=NULL to method __dorRequest
 *         to match parent class header and prevent E_STRICT messages
 *       - add property timeout to method __dorRequest(line 124):
 ...
 */
	...
	function __doRequest($request, $location, $action, $version, $one_way = NULL) {
		...
		curl_setopt($ch, CURLOPT_CERTINFO, TRUE);
                ...
                // Added by GBoksar to give timeout feature to this class!
                curl_setopt($ch, CURLOPT_TIMEOUT, $this->_timeout);
