...
if (file_exists(dirname(__FILE__) . '/basic-doc_firmado_exc_c14n.xml')) {
    unlink(dirname(__FILE__) . '/basic-doc_firmado_exc_c14n.xml');
}
...
$objDSig->add509Cert(file_get_contents( '/etc/rade/cert/rade.crt'));

$objDSig->appendSignature($doc->documentElement);
$doc->save(dirname(__FILE__) . '/basic-doc_firmado_exc_c14n.xml');
...
//	echo "NOT THE SAME";
$sign_output = file_get_contents(dirname(__FILE__) . '/basic-doc_firmado_exc_c14n.xml');
print $sign_output;
?>
